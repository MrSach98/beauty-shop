...
@csrf
<input type="hidden" name="product_type" value="{{ $selectedType->slug ?? '' }}">
    ...
    <div class="card-body py-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted">Fill in the product details in the tabs below</small>
            </div>
            <div class="ms-auto">
    ...
    @if($selectedType)
        @foreach($selectedType->tabs ?? [] as $tab)
            @php
                ...
                $meta = $tabMeta[$tab] ?? ['icon'=>'📦','label'=>ucfirst($tab).' Details'];
            @endphp
            <li class="nav-item">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <button type="button" class="btn btn-outline-secondary"
                        id="generateSku" title="Generate SKU">
        ...
        <div class="col-md-4">
            ...
            <select name="subcategory_id" id="subSelect" class="form-select">
                <option value="">-- First Category Select --</option>
            </select>
        </div>
        <div class="col-md-4">
            ...
            <select name="child_subcategory_id" id="childSelect" class="form-select">
                <option value="">--First Fill Subcategory --</option>
            </select>
        </div>
        <div class="col-md-12">
            ...
            <small class="text-muted">Separate using Enter or a comma</small>
        </div>
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap gap-4">
                ...
                <div class="form-check form-switch">
                    <input type="checkbox" name="product_on_sale"
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="low_stock_alert" class="form-control"
                   placeholder="5" value="5" min="0">
        </div>
        <div class="col-md-4">
            <label class="form-label fw-semibold d-block mb-3">&nbsp;</label>
            <div class="alert alert-warning py-2 mb-0 small">
                <i class="bi bi-bell me-1"></i>
                You'll be notified if the Stock goes below this
            </div>
        </div>
    </div>
</div>
                    ...
                    <div id="colorsContainer">
                        <div class="color-row d-flex gap-2 align-items-center">
                            <input type="text" name="colors[]"
                                   class="form-control" placeholder="Color name (e.g. Red)">
                            <button type="button"
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="purity" class="form-control"
                           placeholder="e.g. 22KT, 925 Sterling">
                </div>
                <div class="col-md-4">
        ...
        <div class="tab-pane fade p-4 bg-white shadow-sm" id="tab-sports">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <div id="supplFields" style="display:none">
                        <div class="row g-3">
                            <div class="col-md-4">
        ...
        <div class="tab-pane fade p-4 bg-white shadow-sm" id="tab-baby">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Material</label>
                    <input type="text" name="material" class="form-control"
                           placeholder="e.g. BPA-Free Plastic">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Net Weight</label>
                    <input type="text" name="net_weight" class="form-control">
...
<div class="tab-pane fade p-4 bg-white shadow-sm" id="tab-media">
    ...
    <div class="row g-4">
        <div class="col-md-4">
            ...
            <img id="img1Preview" class="img-preview-thumb">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="file" name="image{{ $n }}" id="img{{ $n }}"
                   class="form-control" accept="image/*">
            <img id="img{{ $n }}Preview" class="img-preview-thumb">
        </div>
        @endforeach
        <div class="col-md-12">
            <label class="form-label fw-semibold">
                Gallery Images (multiple)
                <small class="text-muted fw-normal">(Max 2MB each)</small>
            </label>
...
<div class="tab-pane fade p-4 bg-white shadow-sm" id="tab-desc">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-12">
            ...
            <textarea name="how_to_use" class="form-control" rows="3"
                      placeholder="Step by step usage..."></textarea>
        </div>
        <div class="col-md-12">
            <label class="form-label fw-semibold">
                Features / Highlights
                <small class="text-muted fw-normal">Line By Line Features</small>
            </label>
            <textarea name="features" class="form-control" rows="4"
                      placeholder="Long lasting formula&#10;SPF 30 protection"></textarea>
        </div>
    </div>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="meta_description" class="form-control" rows="2"
                              placeholder="SEO description (160 chars max)"></textarea>
                </div>
                <div class="col-md-12">
...
$(document).ready(function() {
    ...
    $('#generateSku').on('click', function() {
        $.get('{{ route("admin.products.generate-sku") }}', function(res) {
            $('#skuField').val(res.sku);
        });
    });
    ...
    $('#catSelect').on('change', function() {
        ...
        if (!catId) {
            $('#subSelect').html('<option value="">-- Pehle Category --</option>');
            return;
        }
    ...
    [1,2,3,4,5].forEach(function(n) {
        var inputId   = n === 1 ? 'img1' : 'img'+n;
        var previewId = 'img'+n+'Preview';
